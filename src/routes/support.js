import { getSupportConfig, getSupportMessages, sendSupportMessage, updateSupportConfig } from "../controllers/support.js";
...
export const supportRoutes = async (fastify) => {
    ...
    fastify.put("/support/config", { preHandler: [verifyToken] }, updateSupportConfig);
};
