import { estimatePricing, getPricingConfig, updatePricingConfig, checkSlotPromotions } from "../controllers/pricing.js";
...
export const pricingRoutes = async (fastify) => {
  ...
  fastify.get("/slot-promotions/check", checkSlotPromotions); // Public — apps need this
};
